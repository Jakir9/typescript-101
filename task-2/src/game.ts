...
export function playOneRound(): roundData | null {
...
<<<<<<< HEAD
export function updateModel(model: object, dataForRound: any) {
=======
type gameState = {
  playerScore: number,
...
export function updateModel(model:gameState, dataForRound: roundData):gameState {
>>>>>>> a908f1e (task 2)
...
export function showProgressInConsole(dataForRound: roundData, model: gameState): void{
  console.table([
    {
